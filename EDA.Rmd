...
ggplot(data = filtered_1719, aes_string(x = "SUSPECTED_VIOLENCE", y = "SUSPECT_WEIGHT")) +
  geom_boxplot() +
...
mosaicplot(filtered_1719$SUSPECTED_VIOLENCE ~ filtered_1719$SUSPECT_SEX, data = filtered_1719)
```
...
```{r}
arrest_model <- glm(SUSPECTED_VIOLENCE ~ RACE + SUSPECT_HEIGHT + SUSPECT_WEIGHT + WEAPON_FOUND_FLAG, data = filtered_1719)
tidy(arrest_model)
```
